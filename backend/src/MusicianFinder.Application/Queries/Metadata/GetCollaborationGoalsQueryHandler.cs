...
namespace MusicianFinder.Application.Queries.Metadata
{
    ...
    public class GetCollaborationGoalsQueryHandler : IRequestHandler<GetCollaborationGoalsQuery, List<LookupItemDto>>
    {
        ...
        public GetCollaborationGoalsQueryHandler(IReferenceDataReadRepository referenceRepository)
        {
        ...
        {
            return await _referenceRepository.GetCollaborationGoalsAsync(cancellationToken);
        }
    }
}