...
{
    public class GetSentSuggestionsQueryHandlerTests : TestBase
    {
        private readonly ICollaborationSuggestionReadRepository _suggestionReadRepository;
        private readonly ICurrentUserService _currentUser;
        private readonly IProfileReadRepository _profileReadRepository;
        private readonly GetSentSuggestionsQueryHandler _handler;

        public GetSentSuggestionsQueryHandlerTests(ITestOutputHelper output) : base(output)
        {
            ...
            _handler = new GetSentSuggestionsQueryHandler(_suggestionReadRepository, _currentUser, _profileReadRepository);
        }

        [Fact]
        public async Task Handle_ReturnsSentSuggestions()
        {
            ...
            _suggestionReadRepository.GetSentAsync(profile.Id, 1, 20, Arg.Any<CancellationToken>()).Returns(paged);

            var query = new GetSentSuggestionsQuery { Page = 1, Limit = 20 };
